...
public class Color {
    ...
    @Override
    public int hashCode () {
        int result = (r != +0.0f ? Helper.floatToIntBits(r) : 0);
        result = 31 * result + (g != +0.0f ? Helper.floatToIntBits(g) : 0);
        result = 31 * result + (b != +0.0f ? Helper.floatToIntBits(b) : 0);
        result = 31 * result + (a != +0.0f ? Helper.floatToIntBits(a) : 0);
        return result;
    }

    /** Packs the color components into a 32-bit integer with the format ABGR and then converts it to a float.
     * @return the packed color as a 32-bit float
     * @see Helper#intToFloatColor(int) */
    public float toFloatBits () {
        int color = ((int)(255 * a) << 24) | ((int)(255 * b) << 16) | ((int)(255 * g) << 8) | ((int)(255 * r));
        return Helper.intToFloatColor(color);
    }
    ...
    public static float toFloatBits (int r, int g, int b, int a) {
        ...
        float floatColor = Helper.intToFloatColor(color);
        return floatColor;
    }
    ...
    public static void abgr8888ToColor (Color color, float value) {
        int c = Helper.floatToIntColor(value);
